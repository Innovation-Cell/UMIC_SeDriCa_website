...
function Mash(){
    ...
    <div class="col-md-6 mx-auto my-5 text-center">
      ...
      <div className="mt-4 mx-3"><p> Raj Mashruwala, a distinguished alumnus of IIT Bombay's Mechanical Engineering class of 1975, has played a pivotal role in the growth and success of Team SeDriCa through his unwavering support of the Unmesh Mashruwala Innovation Cell (UMIC). 
        </p>
...
<p> The entire team owes a deep debt of gratitude to Raj Mashruwala, whose continuous mentorship, guidance, and goodwill have been instrumental in shaping their success. His support has not only helped them win national competitions but has also set the stage for future achievements. The team is honored to carry forward the legacy of innovation that he has so generously nurtured.</p>
    </div>
    </div>
    <Footer/>
        </>
